...
const AnchorList = ({
    ...
    return (
        <div className={root}>
            ...
            />
            <div>
                <Button variant="contained" size="medium" color="inherit" className={dutyButton} disabled={isEdit} onClick={() => { 
                    voiceAPI.setAnchorsDuty(selected); 
                    voiceAPI.getAnchorsDutyList();     
                }}>{langConfig.BUTTON_LABEL.CONFIRM}</Button>
