    ...
    <MuiThemeProvider theme={telebetListTheme}>
      <Fragment>
        ...
        <div className={actionButtonWrapper}>
          <Button variant="contained" size="medium" color="inherit" className={clientMuteButtonClass} onClick={() => { toggleMuteChannel(currentChannelId, false, clientMute === MUTE ? UNMUTE : MUTE) }}>{clientMute === MUTE ? <VolumeOffIcon className={icon}/> : <VolumeUpIcon className={icon}/>}{langConfig.BUTTON_LABEL.PLAYER_MUTE}</Button>
          <Button variant="contained" size="medium" color="inherit" className={anchorMuteButtonClass} onClick={() => { toggleMuteChannel(currentChannelId, true, anchorMute === MUTE ? UNMUTE : MUTE) }}>{anchorMute === MUTE ? <VolumeOffIcon className={icon}/> : <VolumeUpIcon className={icon}/>}{langConfig.BUTTON_LABEL.ANCHOR_MUTE}</Button>
...
export default withStyles(styles)(AnswerCallPanel);